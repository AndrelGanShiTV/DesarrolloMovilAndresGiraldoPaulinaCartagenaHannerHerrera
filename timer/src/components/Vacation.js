...
const Vacation = ({ modalVacation, setModalVacation }) => {
    const [date, setDate] = useState(new Date())

    return (
        <Modal
            animationType='slide'
            visible={modalVacation}
        >
            <SafeAreaView>
                ...
                <ScrollView>
                    <View>
                        <Text style={style.label}>Select vacation start date:</Text>
                        <DatePicker
                            locale='es'
                            mode='date'
                            date={date}
                    ...
                    <View>
                        <Text style={style.label}>Select vacation end date:</Text>
                        <DatePicker
                            locale='es'
                            mode='date'
                            date={date}
